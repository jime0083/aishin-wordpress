...
$interviews = array(
	...
	array(
		...
		'portrait_img'   => 'IMG-Y11',
		'portrait_label' => 'マネージャー社員ポートレート',
		'qa'             => array(
			array(
				'heading'     => '年齢の壁が、ここにはなかった',
				'body'        => "前職では「あと5年経てば大きな仕事を任せる」と言われていました。アイシンに来て驚いたのは、評価の物差しが年齢でも社歴でもなく、「どんな挑戦をし結果を残したか」だけだったこと。入社2年目に立ち上げた新規事業の検証プロセスが社内標準になり、それが評価されて29歳でマネージャーになりました。\n\n発明評価制度は、若手に有利な制度というわけではありません。誰にとってもフェアで、だからこそ緊張感がある。その健全さが好きです。",
				'photo'       => 'IMG-I05',
			...
			array(
				...
				'photo'       => 'IMG-I09',
				'photo_label' => '山本がマネージャーとしてメンバーと向き合う様子',
			),
			array(
				'heading'     => '次の挑戦者へ',
